defmodule FeedMe.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, FeedMe.Repo)
  ...
  """
  def valid_password?(%FeedMe.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def google_oauth_changeset(user, attrs) do
    ...
    |> unsafe_validate_unique(:email, FeedMe.Repo)
    |> unique_constraint(:email)
    |> unsafe_validate_unique(:google_id, FeedMe.Repo)
