defmodule FeedMe.Repo.Migrations.CreateBudgetsAndSuppliers do
  ...
  def change do
    ...
    create table(:budgets, primary_key: false) do
      ...
      add :period_type, :string, null: false  # weekly, monthly, custom
      add :amount, :decimal, null: false
      add :currency, :string, default: "USD"
      add :ai_authority, :string, default: "recommend"  # recommend, auto_add, auto_purchase
      add :alert_threshold, :decimal  # Alert when spending reaches this percentage
    ...
    create table(:suppliers, primary_key: false) do
      ...
      add :code, :string, null: false  # instacart, amazon_fresh, walmart, etc.
    ...
    create table(:household_suppliers, primary_key: false) do
      ...
      add :credentials, :binary  # Encrypted API credentials
      add :settings, :map, default: %{}
      add :last_synced_at, :utc_datetime
      add :household_id, references(:households, type: :binary_id, on_delete: :delete_all), null: false
      add :supplier_id, references(:suppliers, type: :binary_id, on_delete: :delete_all), null: false
